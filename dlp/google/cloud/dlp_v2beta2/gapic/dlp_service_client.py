...
"""Accesses the google.privacy.dlp.v2beta2 DlpService API."""
...
from google.cloud.dlp_v2beta2.gapic import dlp_service_client_config
from google.cloud.dlp_v2beta2.gapic import enums
from google.cloud.dlp_v2beta2.proto import dlp_pb2
...
class DlpServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.privacy.dlp.v2beta2.DlpService'
    ...
    @classmethod
    def deidentify_template_2_path(cls, project, deidentify_template):
        """Return a fully-qualified deidentify_template_2 string."""
        return google.api_core.path_template.expand(
    ...
    @classmethod
    def inspect_template_2_path(cls, project, inspect_template):
        """Return a fully-qualified inspect_template_2 string."""
        return google.api_core.path_template.expand(
    ...
    def __init__(self,
        ...
        self._inspect_data_source = google.api_core.gapic_v1.method.wrap_method(
            self.dlp_service_stub.InspectDataSource,
            default_retry=method_configs['InspectDataSource'].retry,
            default_timeout=method_configs['InspectDataSource'].timeout,
            client_info=client_info,
        )
    ...
    def inspect_content(self,
        ...
        Example:
            >>> from google.cloud import dlp_v2beta2
            >>>
            >>> client = dlp_v2beta2.DlpServiceClient()
            >>>
        ...
        Args:
            ...
            inspect_config (Union[dict, ~google.cloud.dlp_v2beta2.types.InspectConfig]): Configuration for the inspector. What specified here will override
                the template referenced by the inspect_template_name argument.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.InspectConfig`
            item (Union[dict, ~google.cloud.dlp_v2beta2.types.ContentItem]): The item to inspect.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.ContentItem`
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.InspectContentResponse` instance.
    ...
    def redact_image(self,
        ...
        Args:
            parent (str): The parent resource name, for example projects/my-project-id.
            inspect_config (Union[dict, ~google.cloud.dlp_v2beta2.types.InspectConfig]): Configuration for the inspector.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.InspectConfig`
            image_type (str): Type of the content, as defined in Content-Type HTTP header.
                Supported types are: PNG, JPEG, SVG, & BMP.
            image_data (bytes): The bytes of the image to redact.
            image_redaction_configs (list[Union[dict, ~google.cloud.dlp_v2beta2.types.ImageRedactionConfig]]): The configuration for specifying what content to redact from images.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.ImageRedactionConfig`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.RedactImageResponse` instance.
    ...
    def deidentify_content(self,
        ...
        Args:
            parent (str): The parent resource name, for example projects/my-project-id.
            deidentify_config (Union[dict, ~google.cloud.dlp_v2beta2.types.DeidentifyConfig]): Configuration for the de-identification of the content item.
                Items specified here will override the template referenced by the
                deidentify_template_name argument.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.DeidentifyConfig`
            inspect_config (Union[dict, ~google.cloud.dlp_v2beta2.types.InspectConfig]): Configuration for the inspector.
                Items specified here will override the template referenced by the
                inspect_template_name argument.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.InspectConfig`
            item (Union[dict, ~google.cloud.dlp_v2beta2.types.ContentItem]): The item to de-identify. Will be treated as text.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.ContentItem`
            inspect_template_name (str): Optional template to use. Any configuration directly specified in
                inspect_config will override those set in the template. Singular fields
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.DeidentifyContentResponse` instance.
    ...
    def reidentify_content(self,
        ...
        Args:
            ...
            reidentify_config (Union[dict, ~google.cloud.dlp_v2beta2.types.DeidentifyConfig]): Configuration for the re-identification of the content item.
            ...
            inspect_config (Union[dict, ~google.cloud.dlp_v2beta2.types.InspectConfig]): Configuration for the inspector.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.InspectConfig`
            item (Union[dict, ~google.cloud.dlp_v2beta2.types.ContentItem]): The item to re-identify. Will be treated as text.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.ContentItem`
            inspect_template_name (str): Optional template to use. Any configuration directly specified in
                ``inspect_config`` will override those set in the template. Singular fields
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.ReidentifyContentResponse` instance.
    ...
    def inspect_data_source(self,
        ...
        repository. `How-to guide <https://cloud.google.com/dlp/docs/inspecting-storage>`_
        ...
        Example:
            ...
            >>> parent = client.project_path('[PROJECT]')
            >>>
            >>> response = client.inspect_data_source(parent)

        Args:
            parent (str): The parent resource name, for example projects/my-project-id.
            job_config (Union[dict, ~google.cloud.dlp_v2beta2.types.InspectJobConfig]): A configuration for the job.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.InspectJobConfig`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.DlpJob` instance.
        ...
        if metadata is None:
            metadata = []
        metadata = list(metadata)
        request = dlp_pb2.InspectDataSourceRequest(
            parent=parent,
            job_config=job_config,
        )
        return self._inspect_data_source(
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def analyze_data_source_risk(
        ...
        Example:
            ...
            >>> parent = client.project_path('[PROJECT]')
            >>>
            >>> response = client.analyze_data_source_risk(parent)

        Args:
            parent (str): The parent resource name, for example projects/my-project-id.
            job_config (Union[dict, ~google.cloud.dlp_v2beta2.types.RiskAnalysisJobConfig]): Configuration for this risk analysis job.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.RiskAnalysisJobConfig`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        return self._analyze_data_source_risk(
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def list_info_types(self,
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.ListInfoTypesResponse` instance.
    ...
    def create_inspect_template(
        ...
        Args:
            ...
            inspect_template (Union[dict, ~google.cloud.dlp_v2beta2.types.InspectTemplate]): The InspectTemplate to create.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.InspectTemplate`
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.InspectTemplate` instance.
    ...
    def update_inspect_template(
        ...
        Example:
            ...
            >>> client = dlp_v2beta2.DlpServiceClient()
            >>>
            >>> name = client.inspect_template_path('[ORGANIZATION]', '[INSPECT_TEMPLATE]')
            >>>
        ...
        Args:
            ...
            inspect_template (Union[dict, ~google.cloud.dlp_v2beta2.types.InspectTemplate]): New InspectTemplate value.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.InspectTemplate`
            update_mask (Union[dict, ~google.cloud.dlp_v2beta2.types.FieldMask]): Mask to control which fields get updated.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.FieldMask`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def list_inspect_templates(self,
        ...
        Returns:
            ...
            is an iterable of :class:`~google.cloud.dlp_v2beta2.types.InspectTemplate` instances.
    ...
    def create_deidentify_template(
        ...
        Args:
            parent (str): The parent resource name, for example projects/my-project-id or
                organizations/my-org-id.
            deidentify_template (Union[dict, ~google.cloud.dlp_v2beta2.types.DeidentifyTemplate]): The DeidentifyTemplate to create.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.DeidentifyTemplate`
            template_id (str): The template id can contain uppercase and lowercase letters,
                numbers, and hyphens; that is, it must match the regular
                expression: ``[a-zA-Z\\d-]+``. The maximum length is 100
                characters. Can be empty to allow the system to generate one.
        ...
        Returns:
            A :class:`~google.cloud.dlp_v2beta2.types.DeidentifyTemplate` instance.
    ...
    def update_deidentify_template(
        ...
        Example:
            ...
            >>> client = dlp_v2beta2.DlpServiceClient()
            >>>
            >>> name = client.deidentify_template_path('[ORGANIZATION]', '[DEIDENTIFY_TEMPLATE]')
            >>>
        ...
        Args:
            ...
            deidentify_template (Union[dict, ~google.cloud.dlp_v2beta2.types.DeidentifyTemplate]): New DeidentifyTemplate value.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dlp_v2beta2.types.DeidentifyTemplate`
            update_mask (Union[dict, ~google.cloud.dlp_v2beta2.types.FieldMask]): Mask to control which fields get updated.
                If a dict is provided, it must be of the same form as the protobuf
    ...
    def list_deidentify_templates(
        ...
        Returns:
            A :class:`~google.gax.PageIterator` instance. By default, this
            is an iterable of :class:`~google.cloud.dlp_v2beta2.types.DeidentifyTemplate` instances.
            This object can also be configured to iterate over the pages
            of the response through the `options` parameter.
    ...
    def list_dlp_jobs(self,
        ...
        Args:
            ...
            page_size (int): The maximum number of resources contained in the
                ...
                streaming is performed per-page, this determines the maximum number
                of resources in a page.
            type_ (~google.cloud.dlp_v2beta2.types.DlpJobType): The type of job. Defaults to ``DlpJobType.INSPECT``
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.gax.PageIterator` instance. By default, this
            is an iterable of :class:`~google.cloud.dlp_v2beta2.types.DlpJob` instances.
            This object can also be configured to iterate over the pages
            of the response through the `options` parameter.
